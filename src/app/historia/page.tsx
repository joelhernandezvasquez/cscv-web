    ...
    <main className={style.content_container}>
       ...
       <section className={style.content_container}>
         ...
         <p className={`${regularText.className} ${'content_text'}`}>
          ...
          Los primeros ocho miembros de la comunidad fueron el Siervo de Dios Padre Emiliano Tardif M.S.C., el Diacono Evaristo y su esposa Yolanda Guzmán, María Armenteros Malla, John y Nidia Fleury, Pura Deogracia y Emenegilda Almánzar.
         </p>

         <p className={`${regularText.className} ${'content_text'}`}>
          Cuenta con el reconocimiento eclesial de la Conferencia Episcopal de la República Dominicana por 41 años, se encuentra presente en nueve países y ha establecido 30 casas. 
          En los Estados Unidos tenemos Casas de Oración en Miami, Orlando, San Diego, Brooklyn, Dodge City, Omaha, El Paso, Boston y una Célula Fraterna en Dallas.
         </p>
         ...
         <p className={`${regularText.className} ${'content_text'}`}>
         En la Diócesis de Brooklyn, la Comunidad Siervos de Cristo Vivo fue fundada en 1999 y el 1 de enero de 2009 fue reconocida en forma oficial y aceptada por el S.E.R. Nicholas DiMarzio, Obispo de Brooklyn, como una asociación privada de fieles en conformidad con la ley de la iglesia canon 298. 
         Desde entonces la comunidad tiene su sede y Casa de Óracion en el 207 Hendrix Street, Brooklyn NY 11207.
         </p>

         <p className={`${regularText.className} ${'content_text'}`}>
         La CSCV funciona en forma independiente en conformidad con sus estatutos bajo la dirección de su Consejo Local, de su Asesor Espiritual y supervisión del Consejo de la provincia de los Estados Unidos.
         </p>
         ...
         <div className={style.grid_column_content}> 
           <div>
           <p className={`${regularText.className} ${'content_text'}`}>
           Al fin de este año, el Consejo Local podría invitar a un candidato pasar a ser un <span className={titleHeadline.className}>ASPIRANTE</span> por un período mínimo de dos años.
           </p>

           <p className={`${regularText.className} ${'content_text'}`}>
           Al fin de dos años el Consejo General podría invitar a un aspirante ser un miembro, o sea: un <span className={titleHeadline.className}>SIERVO DE CRISTO VIVO</span>. Quedan incluidos aquellos que han hecho votos de consagración como diáconos permanentes. Los sacerdotes y religiosos pueden ser acompañantes de la Comunidad.
           </p>
           </div>
